...
const (
	Logger_GetLogger_FullMethodName     = "/spire.api.server.logger.v1.Logger/GetLogger"
	Logger_SetLogLevel_FullMethodName   = "/spire.api.server.logger.v1.Logger/SetLogLevel"
	Logger_ResetLogLevel_FullMethodName = "/spire.api.server.logger.v1.Logger/ResetLogLevel"
)
